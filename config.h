...
#define RED_OUT        LATCbits.LATC2
#define BLUE_OUT        LATCbits.LATC1
#define GREEN_OUT      LATCbits.LATC6

#define LED_MUX_ADDR_B         LATCbits.LATC7
#define LED_MUX_ADDR_A         LATBbits.LATB0

#define LED_LINE_A            LATBbits.LATB4
#define LED_LINE_B            LATBbits.LATB5

#define BUZZER_OUT            LATBbits.LATB1
#define SERVO_OUT            LATBbits.LATB2

#define BUTTON_INT           LATBbits.LATB3
#define BUTTON_ADDR_A         LATBbits.LATB6
#define BUTTON_ADDR_B         LATBbits.LATB7
#define BUTTON_ADDR_C         LATBbits.LATA0

#define IND_RED         LATBbits.LATA1
#define IND_BLUE        LATBbits.LATA2
#define IND_GREEN         LATBbits.LATA3
...
extern unsigned char ioexp_output;
extern unsigned char led_output;
extern unsigned int ldr_1;
